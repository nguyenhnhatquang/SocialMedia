...
const {validImages} = require("../utils/Validate");
...
const postCtrl = {
    createPost: async (req, res) => {
        try {
            ...
            if (validImages(images)) {
                return res.status(400).json({msg: validImages(images)});
            }
    ...
    likePost: async (req, res) => {
        try {
            ...
            if (post.length > 0) {
                return res
                    .status(400)
                    .json({msg: "Bạn đã like bài viết này"});
            }
    ...
    unLikePost: async (req, res) => {
        try {
            ...
            res.json({msg: "Unliked thành công"});
        } catch (err) {
            return res.status(500).json({msg: err.message});
        }
    },
    ...
    reportPost: async (req, res) => {
        try {
            ...
            if (post.length > 0) {
                return res
                    .status(400)
                    .json({msg: "Bạn đã báo cáo bài viết này"});
            }
    ...
    savePost: async (req, res) => {
        try {
            ...
            if (user.length > 0) {
                return res
                    .status(400)
                    .json({msg: "Bạn đã lưu bài viết này"});
            }
    ...
    unSavePost: async (req, res) => {
        try {
            ...
            res.json({msg: "Huỷ lưu thành công"});
        } catch (err) {
            return res.status(500).json({msg: err.message});
        }
    },
